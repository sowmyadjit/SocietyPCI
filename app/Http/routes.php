	...
	Route::group(['prefix' => '/'], function()
	{
		...
		Route::group(['middleware' => ['auth']], function() {
			...
			Route::group(['middleware' => ['revalidate']], function() {
				...
				Route::post('/swap_sb_tranid','AccountController@swap_sb_tranid');
				Route::post('/delete_sb_tranid','AccountController@delete_sb_tranid');
				...
				Route::post('/cdsd_close_index','DepositController@cdsd_close_index');
				...
				Route::match(["post"],'/create_service_charge','InterestController@create_service_charge');
				...
				Route::get('/jewel_loan_report','LoanController@jewel_loan_report');
				Route::get('/jewel_loan_individual_report','LoanController@jewel_loan_individual_report');
				Route::get('/jewel_loan_individual_report_data','LoanController@jewel_loan_individual_report_data');
				Route::match(["get","post"],'/jewel_loan_repay_report_data','LoanController@jewel_loan_repay_report_data');
				Route::match(["get","post"],'/repay_report_data','LoanController@repay_report_data');
...
/*****************************/
				Route::get('/Receipt','DLRepaymentController@Receipt');
...
/*******************************/
		Route::post('/is_jl_first_repay_done','DLRepaymentController@is_jl_first_repay_done');
