					...
					<div class="form-group">
						<div class="row table-row alert alert-info">
							...
							<label class="control-label inline col-md-4 Single">Select Account Number / ALL:
								<input class="SearchTypeaheadAPR form-control" id="searchaccAPR" type="text" name="searchaccAPR" placeholder="SELECT PIGMY ACCOUNT"> 
							</label>
							...
							<div class="SerchParams">
								...
								<div class="col-md-2">
									<a class="btn btn-default SearchAPR pull-left">SEARCH</a>
								</div>
								
								<div class="col-md-1 pull-left">
									<a class="btn btn-default PrintAPR">PRINT</a>
...
<script>
	...
	$('.SearchAPR').click(function(e){
		//e.preventDefault();
		All=$('#searchaccAPR').val();
		Rmode=$('#ARMode').val();
		if(Rmode=="SINGLE")
		{
