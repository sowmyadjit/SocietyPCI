							...
							<tr class="borderprint">
								<td rowspan="6" width="60%" class="borderprint ">
									<b>NAME&nbsp:</b>&nbsp
										...
										<?php if(!empty($FdCertiDetails->FatherName)) { echo '( Father/Mother ): '.  $FdCertiDetails->FatherName ; } else { echo '( Husband/Wife ) :'.$FdCertiDetails->SpouseName;  } ?><br/>
									...
									<tr class="borderprint">
										...
										<td class="borderprint">
											{{ $FdCertiDetails->NumberOfDays }} Days
										</td>
									</tr>
