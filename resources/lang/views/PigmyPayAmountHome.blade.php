...
<div id="content" class="col-lg-10 col-sm-10">
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a class="clickme" >Pigmy Pay Amount</a>
			</li>
		</ul>
	</div>
					...
					<div class="alert alert-info">
						<div class="form-group">
							...
							<div class="row table-row">
								...
								<a href="PigmyPayAmountView" class="btn btn-default PayAmountLink">Pay Amount</a>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="button" value="RECEIPT" class="btn btn-info btn-sm ReceiptPrint" href="PigmyPayAmountReceipt/{{ $PAmt->PayId }}/{{ $PAmt->PayAmount_IntType }}"/>
