			...
			<div class="box col-md-12">
				...
				<!--<div class="box-content">
					...
					<div class="row table-row alert alert-info">
							...
							<div class="col-md-4">
								<input class="SearchTypeahead form-control" id="searchacc" type="text" name="searchacc" placeholder="SELECT RD ACCOUNT"> 
							</div>
							...
							<div class="col-md-2">
							<a class="btn btn-default SearchRd pull-left">SEARCH</a>
							</div>
...
$('input.SearchTypeahead').typeahead({
      ajax: '/GetSearchRdAcc' //SEND BID OF THE LOGGED IN USER ALONG WITH  THIS
});
