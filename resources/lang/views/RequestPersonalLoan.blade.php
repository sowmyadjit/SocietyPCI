				...
				<div class="box-content">
					...
					<div class="PersonalLoan">
						...
						<div class="form-group">
							...
							<div id="the-basics" class="col-md-3">
								<input class="ReqPersMemnameTypeahead form-control"  type="text" placeholder="SELECT MEMBER NAME" id="ReqPersMemname" Required>  
							</div>
						</div>
					...
					<div class="StaffLoan">
						...
						<div class="form-group">
							...
							<div id="the-basics" class="col-md-3">
								<input class="ReqStfEmpnameTypeahead form-control"  type="text" placeholder="SELECT EMPLOYEE NAME" id="ReqStfEmpname">  
							</div>
						</div>
	...
	$('.ReqPersSbmBtn').click( function(e) 
	{
		if(indexid==0)
		{
			...
			$.ajax({
				...
				type: 'post',
				data: $('#form_ReqPerLoan').serialize()+'&ReqPLBranchID='+PLBrnch+'&ReqPLMembID='+Member+'&ReqEmpID='+Empid+'&ReqCustID='+Custid,
				success: function(data) {
