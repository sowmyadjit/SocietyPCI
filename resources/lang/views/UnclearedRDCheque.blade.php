...
<label class="control-label col-sm-4">Cheque Reject Amount:</label>
  ...
  <tr>
       @foreach ($rdcheque as $rd_transaction)
        <tr>
             ...
             <td>{{ $rd_transaction->FirstName }}</td>
             <td>{{ $rd_transaction->MiddleName }}</td>
             <td>{{ $rd_transaction->LastName }}</td>
			 ...
			 <td>
									<div class="form-group">
										<div class="col-sm-12">
											<input type="button" value="Accept" class="btn btn-info btn-sm accpbtn" href="rdclearcheque/{{ $rd_transaction->RD_TransID }}"/>
