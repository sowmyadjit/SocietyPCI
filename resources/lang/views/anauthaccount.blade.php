...
<div class="box-inner">
	...
	<div class="box-content">
		<div class="alert alert-info">
			<a href="rejectedaccount" class="btn btn-default crtacc">Rejected Account</a>
		</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div class="form-group">
							<div class="col-sm-12">
								<input type="button" value="REject" class="btn btn-info btn-sm rejbtn" href="rejectaccount/{{ $createaccount->Accid }}"/>
							</div>
						</div>
					</td>
				</tr>
