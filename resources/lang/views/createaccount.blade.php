		...
		<div class="box col-md-12">
			<div class="box-inner">
				...
				<div class="box-content">
					<div class="alert alert-info row table-row">
					...
					<thead>
					<tr>
						<th>Account Number / Old Account Number</th>
						<th>Agent ID</th>
						<th>Account Type</th>
					...
					<tr>
						...
						<td><a  href="accountdetails/{{ $createaccount->Accid }}" class="viwbtn">{{ $createaccount->AccNum }} / {{ $createaccount->Old_AccNo }} </a> </td>
						<td>{{ $createaccount->Agent_ID }}</td>
						<td>{{ $createaccount->Acc_Type }}</td>
						<!--<td>{{ $createaccount->AccountCategory }}</td>-->
