								...
								<div class="row">
									...
									<div class="form-group">
										...
										<div id="the-basics" class="col-sm-6">
											<input class="PersMemnameTypeahead form-control"  type="text" placeholder="SELECT MEMBER NAME" id="PersMemname"  onblur="GetLoanCharge()" Required>  
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control hidden" id="PersOthrChrges" name="PersOthrChrges" placeholder="OTHER CHARGE" onclick="CheckInCash()">
											
											<input type="text" class="form-control" id="TotOthrchrg" name="TotOthrchrg" placeholder="OTHER CHARGE">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control hidden" id="PersBkfrmChrg" name="PersBkfrmChrg" placeholder="BOOK AND FORMS CHARGE">
											
											<input type="text" class="form-control" id="TotBkfrmChrg" name="TotBkfrmChrg" placeholder="BOOK AND FORMS CHARGE">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control hidden" id="PersAdjChrg" name="PersAdjChrg" placeholder="ADJUSTMENT CHARGE">
											
											<input type="text" class="form-control" id="TotAdjChrg" name="TotAdjChrg" placeholder="ADJUSTMENT CHARGE">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control hidden" id="PersShrChrg" name="PersShrChrg" value="630">
											
											<input type="text" class="form-control" id="ShareChrg" name="ShareChrg" >
										</div>
									</div>
	...
	function GetLoanCharge()
	{
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('#TotOthrchrg').val(TotOthrchrg);
				$('#TotBkfrmChrg').val(TotBkfrmChrg);
				$('#TotAdjChrg').val(TotAdjChrg);
				$('#ShareChrg').val(ShareChrg);
