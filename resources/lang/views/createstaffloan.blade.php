								...
								<div class="col-md-6 alert-success">
									<div class="row">
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input class="form-control" id="StfAdjCharge" name="StfAdjCharge" placeholder="ADJUSTMENT CHARGE" type="text">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<input class="form-control" id="StfShrChrg" name="StfShrChrg" placeholder="SHARE CHARGE" value="500" type="text">
											</div>
										</div>
									</div>
								</div>
...
/*	function StfEndDate(){
	...
	*/
	...
	//Get InhandCash
	/*$('.StfBranchTypeAhead').change(function(e){
		
		brid=$('.StfBranchTypeAhead').data('value');
		...
		success:function(data)
		{
		$('#StfLoanInhand').val(data['inhand']);
		//incash=$('#StfLoanInhand').val();
		//alert(incash);
		}
		});
	});*/
