			...
			<div class="box-inner">
				...
				<div class="box-content">
					<div class="alert alert-info">
						<a href="custrejectview" class="btn btn-default crtmem">view Reject Customer</a>
					</div>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<div class="form-group">
										<div class="col-sm-12">
											<input type="button" value="Accept" class="btn btn-info btn-sm accustpbtn" href="authorisecust/{{ $customer->Custid }}"/>
										</div>
									</div>
									</td>
									<td>
								<div class="form-group">
										<div class="col-sm-12">
											<input type="button" value="REject" class="btn btn-info btn-sm rejbtn" href="rejectcust/{{ $customer->Custid }}"/>
										</div>
									</div>
									</td>
