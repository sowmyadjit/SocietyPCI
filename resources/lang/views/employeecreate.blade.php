				...
				<div class="box-content">
					...
					<div class="col-md-6">
						<div class="row">
							...
							<div class="form-group">
								<label class="control-label col-sm-4">Father/spouse Name:</label>
								<div class="col-md-8">
									<input type="text" class="form-control" id="fsname" name="fsname" placeholder="Father/spouse Name">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="doj" name="doj" placeholder="doj" required>
								</div>
							</div>
					...
					<div class="col-md-6">
						<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="da" name="da" placeholder="DA" required>
								</div>
							</div>
