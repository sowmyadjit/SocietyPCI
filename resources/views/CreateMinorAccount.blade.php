...
<div id="content<?php echo $MAccCrt['module']->Mid; ?>" class="col-md-12">
	<div class="row">
		<div class="box_bdy_<?php echo $MAccCrt['module']->Mid; ?> box col-md-12">
			<div class="bdy_<?php echo $MAccCrt['module']->Mid; ?> box-inner">
...
<input type="text" class="form-control hidden" id="x" name="x" >
				...
				<center>
					...
					<div class="form-group">
						<div class="col-sm-12">
						 <input type="button" value="CREATE" class="btn btn-success btn-sm sbmbtn<?php echo $MAccCrt['module']->Mid; ?>"/>
						 <input type="button" value="CANCEL" class="btn btn-danger btn-sm cnclbtn<?php echo $MAccCrt['module']->Mid; ?>"/>
...
<script>
//Cancel button
  $('.cnclbtn<?php echo $MAccCrt['module']->Mid; ?>').click(function(e)
{
	alert('are you sure?');
	$('.accclassid').click();
});
...
//Submit button
$('.sbmbtn<?php echo $MAccCrt['module']->Mid; ?>').click( function(e) {
