...
<div id="content<?php echo $MCustCreate['module']->Mid; ?>" class="col-md-12">
	<div class="row">
	
			<div class="box_bdy_<?php echo $MCustCreate['module']->Mid; ?> box col-md-12">
				<div class="bdy_<?php echo $MCustCreate['module']->Mid; ?> box-inner">
				...
				<div class="alert alert-success col-md-12">
					<div class="row">
						...
						<center>
							<div class="form-group">
							<div class="col-sm-12">
								<input type="submit" value="CREATE" class="btn btn-success btn-sm sbmbtn<?php echo $MCustCreate['module']->Mid; ?>"/>
								<input type="button" value="CANCEL" class="btn btn-danger btn-sm cnclbtn<?php echo $MCustCreate['module']->Mid; ?>"/>
...
$('#chk').click(function(e){
	...
	$('.cnclbtn<?php echo $MCustCreate['module']->Mid; ?>').click(function(e){
