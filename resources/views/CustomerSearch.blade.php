			...
			<div class="bdy_<?php echo $c['module']->Mid; ?> box-inner">
				...
				<div class="box-content">
					<table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
						...
						<tbody>
							@foreach ($c['CustData'] as $customer)
							<tr>
								...
								<td>
									<div class="form-group">
										<div class="col-sm-12">
											<input type="button" value="EDIT" class="btn btn-info btn-sm edtbtn<?php echo $c['module']->Mid; ?>" href="customerdetails/{{ $customer->Custid }}/edit"/>
										</div>
									</div>
								</td>
								...
								<td>
									<div class="form-group">
										<div class="col-sm-12">
											<input type="button" value="RECEIPT" class="btn btn-info btn-sm ReceiptPrint<?php echo $c['module']->Mid; ?>" href="CustomerReceipt/{{ $customer->Custid }}"/>
										</div>
									</div>
								</td>
								@else
...
<script>
	...
	$('.ReceiptPrint<?php echo $c['module']->Mid; ?>').click(function(e){
		e.preventDefault();
		//alert($(this).attr('href'));
		$('.bdy_<?php echo $c['module']->Mid; ?>').load($(this).attr('href'));
	});
