	...
	$('.JLAccNumTypeAhead, #interest_upto').change(function(e)
	{
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				LoanType_Interest=data['LoanType_Interest'];
				loan_due_interest=data['loan_due_interest'];
				JewelLoan_remaininginterest = 0;//data['JewelLoan_remaininginterest'];
					...
					success:function(data)
					{
							...
							$.ajax({
								...
								success:function(data)
								{
									...
									if(d1_gt_d2 == 1) {//CONSIDER DUE DAYS
										console.log("1");
										...
										$.ajax({
											url:"/dateComp",
											type:"post",
											data:'&first='+last_paid_date+'&second='+end_date,
											success:function(d1_gt_d2)
											{
												if(parseInt(d1_gt_d2) == 1) {//CONSIDER DUE DAYS - LAST PAID   AFTER   END DATE  -  ALL DAYS ARE DUE DAYS
												//paid after due date
													$.ajax({
														url:"/dateDiff",
														type:"post",
														...
														success:function(data) {
															...
															t2=Math.round(t2);
															jlint = t2 + parseFloat(JewelLoan_remaininginterest);
