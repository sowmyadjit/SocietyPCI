...
<div id="content<?php echo $PayAmount['module']->Mid; ?>" class="col-lg-10 col-sm-10">
    ...
    <div>
        <ul class="breadcrumb">
            ...
            <li>
                <a class="clickme" >FD Pay Amount</a>
			</li>
		</ul>
	</div>
	...
	<div class="row">
		...
		<div class="bdy_<?php echo $PayAmount['module']->Mid; ?> box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-user"></i> FD Pay Amount</h2>
				</div>
					...
					<div class="alert alert-info">
						...
						<div class="form-group">
							...
							<div class="msg1 pull-left"><h5 style="color:red;">Day Is Not Open, Please Contact The Manager</h5></div> 
								...
								<a href="FDPayAmountView" class="btn btn-default PayAmountLink">Pay Amount</a>
								<div class="col-md-5 pull-right">
									<input class="SearchTypeahead<?php echo $PayAmount['module']->Mid; ?> form-control" id="SearchFdPay" type="text" name="SearchFdPay" placeholder="SEARCH FD PAY">
								</div>
