...
<div id="content<?php echo $PendingList['module']->Mid; ?>" class="col-lg-10 col-sm-10">
	<!-- content starts -->
	<!-- <div>
		<ul class="breadcrumb">
		<li>
	...
	<div class="row">
		<div class="box col-md-12">
			<div class="bdy_<?php echo $PendingList['module']->Mid; ?> box-inner">
				...
				<div id='pagei<?php echo $PendingList['module']->Mid; ?>'>
...
<script>
	...
	$("#pagei<?php echo $PendingList['module']->Mid; ?> > ul.pagination li a").each(function() {
		
		$(this).addClass("loadmc<?php echo $PendingList['module']->Mid; ?>");
		
	});
	$('.loadmc<?php echo $PendingList['module']->Mid; ?>').click(function(e)
	{
		e.preventDefault();
		$('#<?php echo $PendingList['module']->Mid; ?>_content').load($(this).attr('href'));
	});
