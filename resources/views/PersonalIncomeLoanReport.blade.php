<div  id="toprint<?php echo $incomepers['module']->Mid; ?>">
<link href="css/bootstrap.min.css" rel='stylesheet' type="text/css" media="all">
				...
				<div id='pagei<?php echo $incomepers['module']->Mid; ?>'>
	...
	$("#pagei<?php echo $incomepers['module']->Mid; ?>ul.pagination li a").each(function() {
 
    $(this).addClass("loadmc");
  
});
$('.loadmc<?php echo $incomepers['module']->Mid; ?>').click(function(e)
{
	e.preventDefault();
	//alert($(this).attr('href'));
	$('.SearchRes<?php echo $incomepers['module']->Mid; ?>').load($(this).attr('href'));
});
	</script>