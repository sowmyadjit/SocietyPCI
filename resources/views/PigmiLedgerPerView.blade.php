<div class="English<?php echo $PigmiLedgerPerData['module']->Mid; ?>">
	<div  id="toprint<?php echo $PigmiLedgerPerData['module']->Mid; ?>">
...
<div id='pagei<?php echo $PigmiLedgerPerData['module']->Mid; ?>'>
...
<center>
	...
	<div class="col-sm-12">
		<input type="button" value="PRINT" class="btn btn-info btn-md print<?php echo $PigmiLedgerPerData['module']->Mid; ?>" id="print<?php echo $PigmiLedgerPerData['module']->Mid; ?>">
	</div>
...
<div class="Kannada<?php echo $PigmiLedgerPerData['module']->Mid; ?>">
	<div  id="toprint1<?php echo $PigmiLedgerPerData['module']->Mid; ?>">
		<link href="css/bootstrap.min.css" rel='stylesheet' type="text/css" media="all">
		<link href="css/bootstrap-cerulean.min.css" rel='stylesheet' type="text/css" media="all">
		<!--this css should be inside the toprint div , for printing the table borders-->	
...
<center>
	...
	<div class="col-sm-12">
		<input type="button" value="ಮುದ್ರಿಸಿ" class="btn btn-info btn-md Knprint<?php echo $PigmiLedgerPerData['module']->Mid; ?>" id="Knprint<?php echo $PigmiLedgerPerData['module']->Mid; ?>">
	</div>
...
<style type="text/css">
	@media print {
	input#print<?php echo $PigmiLedgerPerData['module']->Mid; ?> {
	display: none;
	}
	}
</style> 
...
<style type="text/css">
	@media Knprint {
	input#Knprint<?php echo $PigmiLedgerPerData['module']->Mid; ?> {
	display: none;
	}
	}
</style> 
...
<script>
	...
	$('document').ready(function(){
		...
		if(CheckVal==0)
		{
			$('.English<?php echo $PigmiLedgerPerData['module']->Mid; ?>').show();
			$('.Kannada<?php echo $PigmiLedgerPerData['module']->Mid; ?>').hide();
		}
		
		else
		{
			$('.English<?php echo $PigmiLedgerPerData['module']->Mid; ?>').hide();
			$('.Kannada<?php echo $PigmiLedgerPerData['module']->Mid; ?>').show();
		}
...
<script>
	...
	$(function() {
		$(".print<?php echo $PigmiLedgerPerData['module']->Mid; ?>").click(function() {
			
			var divContents = $("#toprint<?php echo $PigmiLedgerPerData['module']->Mid; ?>").html();
		...
		$(".Knprint<?php echo $PigmiLedgerPerData['module']->Mid; ?>").click(function() {
			
			var divContents = $("#toprint1<?php echo $PigmiLedgerPerData['module']->Mid; ?>").html();
			var printWindow = window.open('', '', 'height=600,width=800');
...
<script>
	$("#pagei<?php echo $PigmiLedgerPerData['module']->Mid; ?> > ul.pagination li a").each(function() {
		
		$(this).addClass("loadmc<?php echo $PigmiLedgerPerData['module']->Mid; ?>");
		
	});
	
	$('.loadmc<?php echo $PigmiLedgerPerData['module']->Mid; ?>').click(function(e)
	{
		e.preventDefault();
		$('.SearchRes<?php echo $PigmiLedgerPerData['module']->Mid; ?>').load($(this).attr('href'));
	});
	</script>		