<div class="English<?php echo $RdLedgerPerData['module']->Mid; ?>">
	<div  id="toprint<?php echo $RdLedgerPerData['module']->Mid; ?>">
...
<div id='pagei<?php echo $RdLedgerPerData['module']->Mid; ?>'>
...
<center>
	...
	<div class="col-sm-12">
		<input type="button" value="PRINT" class="btn btn-info btn-md print<?php echo $RdLedgerPerData['module']->Mid; ?>" id="print<?php echo $RdLedgerPerData['module']->Mid; ?>">
	</div>
...
<div class="Kannada<?php echo $RdLedgerPerData['module']->Mid; ?>">
	<div  id="toprint1<?php echo $RdLedgerPerData['module']->Mid; ?>">
		<link href="css/bootstrap.min.css" rel='stylesheet' type="text/css" media="all">
		<link href="css/bootstrap-cerulean.min.css" rel='stylesheet' type="text/css" media="all">
		<!--this css should be inside the toprint div , for printing the table borders-->	
	...
	<center>
		...
		<div class="col-sm-12">
			<input type="button" value="ಮುದ್ರಿಸಿ" class="btn btn-info btn-md Knprint<?php echo $RdLedgerPerData['module']->Mid; ?>" id="Knprint<?php echo $RdLedgerPerData['module']->Mid; ?>">
		</div>
...
<script>
	...
	$('document').ready(function(){
		...
		if(CheckVal==0)
		{
			$('.English<?php echo $RdLedgerPerData['module']->Mid; ?>').show();
			$('.Kannada<?php echo $RdLedgerPerData['module']->Mid; ?>').hide();
		}
		
		else
		{
			$('.English<?php echo $RdLedgerPerData['module']->Mid; ?>').hide();
			$('.Kannada<?php echo $RdLedgerPerData['module']->Mid; ?>').show();
		}
...
<script>
	$(function() {
		$(".print<?php echo $RdLedgerPerData['module']->Mid; ?>").click(function() {
			
			var divContents = $("#toprint<?php echo $RdLedgerPerData['module']->Mid; ?>").html();
		...
		$(".Knprint<?php echo $RdLedgerPerData['module']->Mid; ?>").click(function() {
			
			var divContents = $("#toprint1<?php echo $RdLedgerPerData['module']->Mid; ?>").html();
			var printWindow = window.open('', '', 'height=600,width=800');
...
<script>
	$("#pagei<?php echo $RdLedgerPerData['module']->Mid; ?> > ul.pagination li a").each(function() {
		
		$(this).addClass("loadmc<?php echo $RdLedgerPerData['module']->Mid; ?>");
		
	});
	
	$('.loadmc<?php echo $RdLedgerPerData['module']->Mid; ?>').click(function(e)
	{
		e.preventDefault();
		$('.SearchRes<?php echo $RdLedgerPerData['module']->Mid; ?>').load($(this).attr('href'));
	});
	</script>										