			...
			<div class="box-inner">
				...
				<div class="box-content">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" id="nos" name="nos" value="{{$shr->PURSH_Noofshares}}" readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" id="bcity" name="bcity" value="{{$shr->PURSH_TotalShareValue}}" readonly>
							
							<input type="text" class="form-control hidden" id="payamt" name="payamt" value="{{$shr->PURSH_TotalShareValue}}">
						</div>
					</div>
...
<script>
	...
	$('.sbmbtn').click( function(e) {
		...
		$.ajax({
			url: 'ShareCloseTran',
			type: 'post',
			data: $('#form_des').serialize()+'&pid='+pid+'&cerificateid='+cerificateid+'&payamt='+payamt+'&tt='+tt,
