...
*/?>
		...
		<table class="table table-striped bootstrap-datatable datatable responsive"></div>
			...
			@if(strcasecmp($data->transaction_type, "DEBIT") == 0 || strcasecmp($data->tran_category, "INCOME") == 0 || strcasecmp($data->tran_category, "EXPENSE") == 0 || strcasecmp($data->tran_category, "BANK_DEP") == 0 || strcasecmp($data->tran_category, "BANK_WID") == 0 || strcasecmp($data->tran_category, "FD_ALLOC") == 0 || strcasecmp($data->tran_category, "KCC_ALLOC") == 0 || strcasecmp($data->tran_category, "SB") == 0 || strcasecmp($data->tran_category, "RD") == 0)
				<tr>
					<td>Account Head:</td>
					<td>
						{{$data->account_head}}
