...
<div class="box_bdy_<?php echo $exp['module']->Mid; ?> box col-md-12">
    <div class="bdy_<?php echo $exp['module']->Mid; ?> box-inner">
				...
				<thead>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											<div class="col-sm-12">
												<input type="button" value="ACCEPT" class="btn btn-success btn-sm accpbtn<?php echo $exp['module']->Mid; ?>" href="expclearcheque/{{ $expense->id }}"/>
									...
									<td>
										<div class="form-group">
											<div class="col-sm-12">
												<input type="button" value="REJECT" class="btn btn-danger btn-sm rejbtn<?php echo $exp['module']->Mid; ?>" />
											</div>
										</div>
									</td>
					...
					<script>
						...
						$('.accpbtn<?php echo $exp['module']->Mid; ?>').click(function(e){
							...
							//$('.box-inner').load($(this).attr('href'));
							//$('.clearclassid').click();
							$('.bdy_<?php echo $exp['module']->Mid; ?>').load($(this).attr('href'));
						});
						
						$('.rejbtn<?php echo $exp['module']->Mid; ?>').click(function(e){
							e.preventDefault();
							$('.chequereject').show();
							m=$('#rdchqrjct').val();
