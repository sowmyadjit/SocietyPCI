					...
					<div class="form-group">
						<div class="row table-row alert alert-info">
							...
							<label class="control-label inline col-md-2">Select Mode:
								...
								<select class="form-control" id="ARMode<?php echo $AgentPigmiRep['module']->Mid; ?>" name="ARMode">
							...
							<label class="control-label inline col-md-4 Single">Select Account Number / ALL:
								<input class="SearchTypeaheadAPR<?php echo $AgentPigmiRep['module']->Mid; ?> form-control" id="searchaccAPR<?php echo $AgentPigmiRep['module']->Mid; ?>" type="text" name="searchaccAPR<?php echo $AgentPigmiRep['module']->Mid; ?>" placeholder="SELECT PIGMY ACCOUNT"> 
							</label>
...
<script>
	...
	$('#ARMode<?php echo $AgentPigmiRep['module']->Mid; ?>').change( function(e) {
		e.preventDefault();
		mode=$('#ARMode<?php echo $AgentPigmiRep['module']->Mid; ?>').val();
		if(mode=="SINGLE")
		{
			$('.Single').show();
			$('.SerchParams').show();
	...
	$('input.SearchTypeaheadAPR<?php echo $AgentPigmiRep['module']->Mid; ?>').typeahead({
		ajax: '/PigmiAccountForAgent' 
	});
	...
	$('.SearchAPR<?php echo $AgentPigmiRep['module']->Mid; ?>').click(function(e){
		...
		if(Rmode=="SINGLE")
		{
			searchvalue=$('#searchaccAPR<?php echo $AgentPigmiRep['module']->Mid; ?>').data('value');	
		}
