...
<div id="content<?php echo $AccCreate['module']->Mid; ?>" class="col-lg-12 col-sm-12">
	<!-- content starts -->
	
	
	<div class="row">
		<div class="box_bdy_<?php echo $AccCreate['module']->Mid; ?> box col-md-12">
			<div class="bdy_<?php echo $AccCreate['module']->Mid; ?> box-inner">
...
<script>
		...
		if($("#form_acc").valid())
		{
			if(a==0)
			{
				...
				$.ajax({
					url: 'createacc',
					type: 'post',
					data: $('#form_acc').serialize()+ '&branchid=' + a + '&acctyp_11=' + acctyp + '&user_ss=' + user_name+'&atype='+acttype+'&agid='+agentid+'&AccNum='+AccNum,
					success: function(data) {
						alert('success');
						$('.sbclassid').click();
					}
	...
	$('.typeahead1').change(function(e){
		...
		if(ft=="RD"||ft=="Recurring Deposit")
		{
			...
			$('#durationyearclass').show();//Newly Added
