...
<script src="js/jquery.validate.min.js"></script>
	...
	<div id="content<?php echo $agentuplode['module']->Mid; ?>" class="col-md-10">
		<div class="row">
			<div class="box col-md-12">
				<div class="bdy_<?php echo $agentuplode['module']->Mid; ?> box-inner">
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<input type="button" value="CANCEL" class="btn btn-danger btn-sm cnclbtn<?php echo $agentuplode['module']->Mid; ?>"/>
...
<script>
	...
	$('.cnclbtn<?php echo $agentuplode['module']->Mid; ?>').click(function(e){
	$('#download_link').hide();
