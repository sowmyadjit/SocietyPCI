<script src="js/bootstrap-typeahead.js"></script>
	...
	<div id="content<?php echo $bd['module']->Mid; ?>" class="col-md-12">
		<div class="row">
			<div class="box_bdy_<?php echo $bd['module']->Mid; ?> box col-md-12">
				<div class="bdy_<?php echo $bd['module']->Mid; ?> box-inner">
				...
				<center>
    					<div class="form-group">
							...
							<div class="col-sm-12">
								<input type="<?php if($edit=='edit'){echo 'button';} else {echo 'hidden';} ?>" value="UPDATE" class="btn btn-success btn-sm sbmbtn<?php echo $bd['module']->Mid; ?>"/>
								<input type="<?php if($edit=='edit'){echo 'button';} else {echo 'hidden';} ?>" value="CANCEL" class="btn btn-danger btn-sm cnclbtn<?php echo $bd['module']->Mid; ?>"/>
								<input type="<?php if($edit=='edit'){echo 'hidden';} else {echo 'button';} ?>" value="CLOSE" class="btn btn-danger btn-sm clsbtn<?php echo $bd['module']->Mid; ?>"/>
							</div>
						</div>
...
<script>
	branchid=0;
	$('.cnclbtn<?php echo $bd['module']->Mid; ?>').click(function(e){
	...
	$('.sbmbtn<?php echo $bd['module']->Mid; ?>').click( function(e) {
