...
<script src="js/jquery.validate.min.js"></script>
	...
	<div id="content<?php echo $company['module']->Mid; ?>" class="col-md-12">
		<div class="row">
			<div class="box_bdy_<?php echo $company['module']->Mid; ?> box col-md-12">
				<div class="bdy_<?php echo $company['module']->Mid; ?> box-inner">
				...
				<div class="form-group">
					...
					<select class="form-control" id="cid" name="cid" placeholder="COMPANY NAME" >
						<?php foreach ($company['branch'] as $key) {
						//print_r($key);
				...
				<div class="form-group">
					<div class="col-sm-12">
						<input type="button" value="CREATE" class="btn btn-success btn-sm sbmbtn<?php echo $company['module']->Mid; ?>"/>
						<input type="button" value="CANCEL" class="btn btn-danger btn-sm cnclbtn<?php echo $company['module']->Mid; ?>"/>
...
<script>
	branchid=0;
	$('.cnclbtn<?php echo $company['module']->Mid; ?>').click(function(e){
	...
	$('.sbmbtn<?php echo $company['module']->Mid; ?>').click( function(e) {
