...
<div id="content<?php echo $p['module']->Mid; ?>" class="col-md-12">
		<div class="row">
...
<!--<input type="button" value="check" class="btn btn-info btn-sm chk"/>-->
    ...
    <div class="form-group">
        <div class="col-sm-12">
         <input type="button" value="CREATE" class="btn btn-success btn-sm sbmbtn<?php echo $p['module']->Mid; ?>"/>
         <input type="button" value="CANCEL" class="btn btn-danger btn-sm cnclbtn<?php echo $p['module']->Mid; ?>"/>
         <input type="reset" value="CLEAR" class="btn btn-info btn-sm resetbtn<?php echo $p['module']->Mid; ?>"/>
        </div></br>
      </div>
      </center>
...
$('.cnclbtn<?php echo $p['module']->Mid; ?>').click(function(e){
	...
	$('.resetbtn<?php echo $p['module']->Mid; ?>').click(function(e){
		var retVal = confirm("Are You Sure ?");
            if( retVal == true ){
...
$('.sbmbtn<?php echo $p['module']->Mid; ?>').click( function(e) {
