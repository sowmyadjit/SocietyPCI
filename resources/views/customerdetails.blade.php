...
<div id="content<?php echo $cd['module']->Mid; ?>" class="col-md-12">
<div class="row">
			<div class="box col-md-12">
				<div class="bdy_<?php echo $cd['module']->Mid; ?> box-inner">
					<div class="box-header well" data-original-title="">
						<h2><i class="glyphicon glyphicon-user"></i> Customer Details <?php echo $cd['module']->Mid; ?> {{$cd['module']->Mid}}</h2>
					...
					<div class="row">
						...
						<div class="hidden"><input type="text" class="form-control" id="cid" name="cid" value="{{ $customer->Custid }}"></div>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
							<input type="text" class="form-control" id="cid" name="cid" value="{{ $customer->Uid }}" <?php echo 'readonly'; ?> >
								</div>
							</div>
						...
						<div class="col-md-8">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<input type="text" class="form-control" id="KaLname" name="KaLname" value="{{ $customer->Kan_LastName }}" placeholder="ಕೊನೆಯ ಹೆಸರು" <?php if($edit=='edit'){}else {echo 'readonly';} ?>>
								</div>
							</div>
