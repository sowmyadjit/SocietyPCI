		...
		<div class="box col-md-12">
			<div class="box-inner">
					<div class="box-header well" data-original-title="">
						<h2><i class="glyphicon glyphicon-user"></i>EDIT  SHARE</h2>
						<div class="box-icon">
			...
			{!! Form::open(['url' => "createshares",'class' => 'form-horizontal','id' => 'form_shares','method'=>'post']) !!}
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="Sclass" name="Sclass"  value="{{$share->Share_Class}}" disabled />
				</div>
				</div>
				...
				<div class="col-md-4">
					<input type="text" class="form-control" id="facevalue" name="facevalue" value="{{$share->Facevalue}}" />
				</div>
				</div>
				<input type="text"class="hidden"value="{{$share->Share_ID}}"id="shareid"name="shareid"/>
				<div class="form-group">
				<label class="control-label col-sm-4" for="first_name">SHARE Fee:</label>
				<div class="col-md-4">
					<input type="text" class="form-control" id="shareprice" name="shareprice" value="{{$share->Share_Price}}" disabled />
				</div>
				</div>
...
<script>
	...
	$('.sbmbtn').click( function(e) {
		newfacevalue=$('#facevalue').val();
		sid=$('#shareid').val();
		e.preventDefault();
		$.ajax({
				url: 'shareedit',
				type: 'post',
				data:'&facevalue='+newfacevalue+'&shareid='+sid,
