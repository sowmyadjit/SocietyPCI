...
<!--Pigmi Transaction-->
				<div class="row pigmi">	
					...
					<div class="form-group">
						...
						<div class="col-md-4 date">
							<div class="input-group input-append date" id="datePicker">
								<input type="text" class="form-control datepicker" name="ptdte"  placeholder="YYYY/MM/DD" data-date-format="yyyy-mm-dd" value="<?php echo date("Y-m-d");?>" readonlyyyy />
								<span class="input-group-addon add-on">
									<span class="glyphicon glyphicon-calendar">
									</span>
								</span>
...
//*alert				alert(lid);
	...
	$('#rdaccount').change(function(e){
		accnum=$('#rdaccount').attr('data-value');
		e.preventDefault();
		$.ajax({
			url:'retrieverdacc',
			type:'post',
