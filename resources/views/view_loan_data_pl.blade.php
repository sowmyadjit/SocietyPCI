                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="alert alert-danger">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4">LOAN CLOSED:</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id ="closed" value="{{$loan_data['closed']}}" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id ="loan_type_id" value="{{$loan_data['loan_type_id']}}" readonly />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-4">PAID PRINCIPLE AMOUTN:</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id ="paid_principle_amt" value="{{$loan_data['paid_principle_amt']}}" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4">INTEREST PAID UPTO:</label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" id ="interest_paid_upto" value="{{$loan_data['interest_paid_upto']}}" readonly />
                                        </div>
                                    </div>
...
<script>
    $('#update_btn').click(function(e) {
		...
		$.ajax({
			...
			type:"post",
			data:"&category=PL"+"&loan_id="+loan_id +"&loan_data_json="+loan_data_json,
